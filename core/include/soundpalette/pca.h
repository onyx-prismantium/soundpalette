...
// Deterministic 2-component PCA over the 7-dim mapping space (extension-2 §7.2): mean-centered
...
struct Pca2 {
    std::array<double, 7> pc1{};
    std::array<double, 7> pc2{};
...
Pca2 compute_pca2(const std::vector<std::array<double, 7>> &points);
